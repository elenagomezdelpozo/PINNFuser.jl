...
# DIFFERENT U0
u0 = [12.0, 12.0, 12.0, 100.0, 0.0, 0.0, 0.0] # Initial conditions pLV, psa, psv, Vlv, Qav, Qmv, Qs

pinn_problem = ODEProblem(pinn_ode!, u0, (0,10)) 
solved_pinn = solve(
    pinn_problem,
    Vern7(),
    saveat = range(0, 10, length = 1500),
    reltol = 1e-6,
    abstol = 1e-6,
    dtmax = 1e-3,
