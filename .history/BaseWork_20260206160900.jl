...
extrap_original_data = Array{Float64}(loaded_data)[1:Int(floor(extrapolation_tspan[2] * number_of_samples_per_cycle)), :]
original_data = extrap_original_data[751:750 + number_of_samples, :]
new_tseps = range(extrapolation_tspan[1], extrapolation_tspan[2], length = Int(floor(extrapolation_tspan[2] * number_of_samples_per_cycle)))
...
plot(plots...,layout = (4,2), size = (900, 800))
