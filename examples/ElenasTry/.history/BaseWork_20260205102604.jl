...
function compute_du(u, trained_p, st, t)
    du = similar(u0)
...
du_nn_mat = [compute_du(solved_pinn.u[k], trained_p, st, solved_pinn.t[k]) for k in 1:length(solved_pinn.t)]

mask_nodel = 750:1500
du_mat_plot = du_mat[751:1500, :]
du_nn_mat_plot = du_nn_mat[0:1500, :]
