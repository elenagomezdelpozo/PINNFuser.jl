...
tsteps = range(5.0, 5.0 + num_of_cycles * τ , length = 3000)
loaded_data = readdlm("/Applications/Desktop/CODE/Thesis/PINNFuser.jl/examples/OneChamberModelCVS/original_data.txt")
extrap_original_data = Array{Float64}(loaded_data)[1:Int(floor(extrapolation_tspan[2] * 1500)), :]
original_data = extrap_original_data[751:750 + 3000, :]
