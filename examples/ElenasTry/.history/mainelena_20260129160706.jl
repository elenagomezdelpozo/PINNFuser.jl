...
loaded_data = readdlm ( / Applications / Desktop / CODE / Thesis / PINNFuser . jl / examples /
OneChamberModelCVS / original_data . txt )
extrap_original_data = Array { Float64 }( loaded_data ) [1: Int ( floor (
extrapolation_tspan [2] * 150) ) , :]
original_data = extrap_origin al_dat a [751:750 + num_of_samples , :]
