...
trained_p, st, U_MEAN, U_STD = LibInfuserNew.PINN_Infuser_new(
    ode_problem,
    NN,
    params,
    tsteps,
...
include("/Applications/Desktop/CODE/Thesis/PINNFuser.jl/src/lib_new.jl")
using .LibInfuserNew
ceil(((extrapolation_tspan[2]-extrapolation_tspan[1]) / τ) * num_of_samples_per_cycle)
LibInfuserNew.PINN_Extrapolator_new(
    ode_problem,
    NN,
    (trained_p, st, U_MEAN, U_STD),
    extrapolation_tspan,
    1500,
...
LibInfuserNew.PINNPlotter_new.plot_PINN_results_new(
    ...
    "/Applications/Desktop/CODE/Thesis/PINNFuser.jl/examples/ElenasTry/elenacvs_comparison_next.png",
)
